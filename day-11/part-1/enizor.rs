...
mod tests {
    ...
    #[test]
    fn run_test() {
        assert_eq!(split_digits(125), None);
        assert_eq!(split_digits(100), None);
        assert_eq!(split_digits(1000), Some((10, 0)));
        assert_eq!(split_digits(10), Some((1, 0)));
        assert_eq!(split_digits(99), Some((9, 9)));
        assert_eq!(split_digits(999), None);
        assert_eq!(run("125 17"), 55312);
    }
}
