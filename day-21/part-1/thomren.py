...
class ThomrenSubmission(SubmissionPy):
    def run(self, s: str):
        ...
        """
        return sum(
            get_shortest_seq_len(code, 3, "num") * int(code[:-1])
...
def test_thomren():
    ...
    """
    assert get_shortest_seq_len("029A", 0, "num") == 4
    assert get_shortest_seq_len("029A", 1, "num") == 12
    assert get_shortest_seq_len("029A", 2, "num") == 28
    assert get_shortest_seq_len("029A", 3, "num") == 68
    assert get_shortest_seq_len("980A", 3, "num") == 60
    assert get_shortest_seq_len("179A", 3, "num") == 68
    assert get_shortest_seq_len("456A", 3, "num") == 64
    assert get_shortest_seq_len("379A", 3, "num") == 64
